            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result.get(0).contains("name")) {
                        ...
                        Log.i("NameEntered",preferences.getString(NAME, "defaultStringIfNothingFound"));
                    ...
                    if(result.get(0).toLowerCase().equals(("thank you my medical assistant").toLowerCase()))
                    {
                        ...
                        mVoiceInputTv.setText("Thank you too " + preferences.getString(NAME, "defaultStringIfNothingFound")+ " .Take care");
                    }
